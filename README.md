...
- OpenAI 호환은 Chat Completions / Responses / Anthropic Messages 형식을 선택하고 기능별 모델명을 직접 입력함. 호환 파라미터 탐색은 제한된 형태만 시도하고 성공 형태를 캐시
...
- 최상위 메뉴: 홈 · 로어 관리 · 로어 추출/변환 · 백업 · 응답 교정 · 연결 · 활동 · 도움말
