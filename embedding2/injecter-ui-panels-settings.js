...
(function(){
  ...
  UI.registerPanel({
    ...
    render: function(panel) {
      ...
      UI.addBox(panel, function(nd) {
        nd.appendChild(UI.createSection('Quick presets', 'Presets reset current options to defaults, then apply the selected setup. Saved lore data is not deleted.'));
      ...
      UI.addBox(panel, function(nd) {
        nd.appendChild(UI.createSection('Core behavior'));
      ...
      UI.addBox(panel, function(nd) {
        nd.appendChild(UI.createSection('Search and continuity'));
      ...
      UI.addBox(panel, function(nd) {
        nd.appendChild(UI.createSection('Modular panel status', 'The main UI has been split into dedicated modules.'));
