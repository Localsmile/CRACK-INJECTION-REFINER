...
(function(){
  ...
  function createModal(opts) {
    ...
    function onKey(e) {
      if (e.key === 'Escape' && opts.closeOnEsc !== false) dispose();
    }
    close.onclick = function(){ if (opts.onClose) opts.onClose(); dispose(); };
    overlay.addEventListener('click', function(e) { if (e.target === overlay && opts.closeOnBackdrop !== false) dispose(); });
