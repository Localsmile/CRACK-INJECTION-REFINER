...
// socket.io 전송 후킹 — 핸드셰이크 토큰 캐처 포함
...
// 모달 탐지 — role=dialog / aria-modal=true 조상을 가지는 textarea[maxLength=500|2000]
function findModal(){
...
// 팝업 공통: dialog 내부에 append + transform containing block 보정 + Radix 방어
