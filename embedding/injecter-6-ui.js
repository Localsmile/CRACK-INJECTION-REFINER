...
(async function(){
  ...
  const requiredSubs = ['main', 'lore', 'merge', 'snapshot', 'file', 'extract', 'refiner', 'log', 'session', 'api'];
  const subFlags = { main: '__subMainLoaded', lore: '__subLoreLoaded', merge: '__subMergeLoaded', snapshot: '__subSnapshotLoaded', file: '__subFileLoaded', extract: '__subExtractLoaded', refiner: '__subRefinerLoaded', log: '__subLogLoaded', session: '__subSessionLoaded', api: '__subApiLoaded' };
