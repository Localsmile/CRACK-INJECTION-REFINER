...
(async function(){
  ...
  const defaultSettings = {
    ...
    temporalRecallJudgeEnabled: false, temporalRecallJudgeModel: 'gemini-3-flash-preview',
    temporalRecallJudgeReasoning: 'minimum', temporalRecallJudgeTimeoutMs: 2500,
    ...
    oocFormat: 'default', oocPromptVersion: OOC_FORMAT_VERSION, rerankEnabled: false, rerankModel: 'gemini-3-flash-preview',
