...
(async function(){
  ...
  },
  {
    ...
    "sections": [
      ...
      {
        "label": "[중요 장면 기억하기]",
        "text": "일반 대화 정리도 뚜렷한 중요 장면을 함께 저장할 수 있음.\n정밀 분석을 켜면 일반 정리 후 중요 장면만 별도 API 호출로 한 번 더 확인함.\n수동 정리에는 기본으로 켜져 있고, 자동 정리나 전체 대화 정리에는 따로 켤 수 있음. 추가 호출만큼 시간과 생성 API 사용량이 늘어남."
      },
      {
        "label": "[과거 장면 불러오기 판단]",
  ...
  },
  {
    ...
    "sections": [
      ...
      {
        "label": "[고급 지시문]",
        "text": "프롬프트 입력 공간은 연결 > 지시문에 모음.\n공통 로어 추출 템플릿, 장면/변환/판단 프롬프트, 후보 재정렬, 응답 검토 지시문을 수정함.\nDeepSeek 전용 프롬프트는 필요할 때만 별도로 켤 수 있음."
      }
    ]
  },
  {
