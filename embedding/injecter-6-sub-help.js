...
(async function(){
  ...
  },
  {
    ...
    "sections": [
      ...
      {
        "label": "[로어팩 관리]",
        "text": "전체 로어팩을 켜고 끄거나 이름 변경, 내보내기, 검색 준비, 삭제함.\n활성화한 로어팩만 현재 채팅에 주입됨.\n개별 로어팩 JSON 가져오기는 백업 화면에서 실행함."
      },
      {
        "label": "[백업/동기화]",
