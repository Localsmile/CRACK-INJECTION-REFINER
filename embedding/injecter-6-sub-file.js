      ...
      const renderPackUI = async (panel) => {
        ...
        panel.addBoxedField('', '', { onInit: async (nd) => {
          ...
          for (const pack of packs) {
            const packDiv = document.createElement('div'); packDiv.style.cssText = 'margin-bottom:8px;border:1px solid var(--li-line,#3f3f46);border-radius:8px;overflow:hidden;background:var(--li-surface,#232327);';
