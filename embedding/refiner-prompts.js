...
{message}`
  ...
  const TOPICS = {
    ...
    honorific:     { label: '7. 호칭 연속성',       desc: '최신 안정 호칭 상태와 명시적 충돌만 검수',       group: 'logic' },
